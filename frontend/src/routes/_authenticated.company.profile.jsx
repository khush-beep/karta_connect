          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col sm:flex-row items-center gap-6 pb-4 border-b">
              <div className="h-20 w-20 border rounded-xl bg-muted flex items-center justify-center overflow-hidden shrink-0 relative group">
                ...
                {uploadingLogo && (<div className="absolute inset-0 bg-background/80 flex items-center justify-center">
            ...
            <div className="grid gap-2">
              ...
              <textarea id="comp-desc" placeholder="Describe your organization's mission, values, and business area..." value={description} onChange={(e) => setDescription(e.target.value)} className="flex min-h-[100px] w-full rounded-md border border-input bg-background px-3 py-2 text-sm shadow-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"/>
            </div>
          </CardContent>
        </Card>
