  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 font-sans">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-500">
        <Link
          to="/login"
          className="mb-6 inline-flex items-center gap-1 text-xs font-semibold text-muted-foreground hover:text-foreground transition-colors"
        >
        ...
        {!success ? (
          <>
            ...
            <form onSubmit={onSubmit} className="mt-6 space-y-4">
              ...
              <Button
                type="submit"
                className="w-full font-bold shadow-md bg-zinc-950 text-zinc-50 hover:bg-zinc-900 focus-visible:ring-zinc-950 dark:bg-zinc-50 dark:text-zinc-950 dark:hover:bg-zinc-200 transition-colors mt-2"
