...
import {
  Loader2, ArrowLeft, User, BookOpen, Award, FileText, ExternalLink, ShieldCheck, ShieldAlert
} from "lucide-react";
    ...
    <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          {/* Accomplishments */}
          {(profile.achievements || profile.extracurriculars) && (
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
          ...
          <Card>
            ...
            <CardContent>
              {applications.length === 0 ? (
                <div className="text-center py-4 text-xs text-muted-foreground">No applications found.</div>
              ) : (
          ...
          {profile.resume_url && (
            <Card>
              ...
              <CardContent>
                ...
                <a
                  href={getResumeDownloadUrl(profile.resume_url)}
                  target="_blank"
