...
import { Loader2, User, BookOpen, Award, FileText, Upload, Plus, X } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1.5 mt-2">
                {skills.length === 0 ? (
                  ...
                  skills.map((skill) => (
                    <span key={skill} className="inline-flex items-center gap-1 bg-muted px-2.5 py-1 rounded-full text-xs font-medium capitalize">
                      {skill}
