...
import { Loader2, User, FileText, CheckCircle2, XCircle, Info, ExternalLink } from "lucide-react";
                  ...
                  <div className="flex gap-4">
                    <div className="h-12 w-12 rounded-full border bg-muted flex items-center justify-center overflow-hidden shrink-0 mt-1">
                      {app.student?.avatar_url ? (
                        <img src={app.student.avatar_url} alt={app.student.name} className="h-full w-full object-cover" />
                      ) : (
